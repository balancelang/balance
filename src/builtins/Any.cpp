...
//     BalanceFunction * bfunction = new BalanceFunction(currentPackage->currentModule, anyType, functionName, parameters, typeType);
//     anyType->addMethod(functionName, bfunction);
//     bfunction->setLlvmFunction(getTypeFunc);
